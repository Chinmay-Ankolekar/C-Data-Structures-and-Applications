...
a. Represent and Evaluate a Polynomial P(x,y,z) =  6x^2y^2z^1-4x^0y^1z^5+3x^3y^1z^1+2x^1y^5z^1-2x^1y^1z^3.
...
OUTPUT
  ...
  Enter the no of terms in the polynomial:5
   Enter the 1 term:
   Coefficient = 6
   Enter Power(x) Power(y) and Power(z):2 2 1

   Enter the 2 term:
   Coefficient = -4
   Enter Power(x) Power(y) and Power(z):0 1 5

   Enter the 3 term:
   Coefficient = 3  
   Enter Power(x) Power(y) and Power(z):3 1 1

   Enter the 4 term:
   Coefficient = 2  
   Enter Power(x) Power(y) and Power(z):1 5 1

   Enter the 5 term:
   Coefficient = -2 
   Enter Power(x) Power(y) and Power(z):1 1 3
  ...
  Enter the 1 term:
  Coefficient = 6
  Enter Power(x) Power(y) and Power(z):4 4 4

  Enter the 2 term:
  Coefficient = 4
  Enter Power(x) Power(y) and Power(z):4 2 1

  Enter the 3 term:
  Coefficient = 5 
  Enter Power(x) Power(y) and Power(z):0 1 1

  Enter the 4 term:
  Coefficient = 10
  Enter Power(x) Power(y) and Power(z):0 1 0

  Enter the 5 term:
  Coefficient = 5
  Enter Power(x) Power(y) and Power(z):0 0 0

  Polynomial 1 is:
  6x^4y^4z^4 + 4x^4y^2z^1 + 5x^0y^1z^1 + 10x^0y^1z^0 + 5x^0y^0z^0
  Enter the POLY2(x,y,z):
  ...
  Enter the 4 term:
  Coefficient = 20
  Enter Power(x) Power(y) and Power(z):0 0 1
  ...
  Polynomial addition result:
  14x^4y^4z^4 + 8x^4y^2z^1 + 5x^0y^1z^1 + 40x^0y^1z^0 + 20x^0y^0z^1 + 8x^0y^0z^0
